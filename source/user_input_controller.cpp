...
extern void ui_controller_init(ui_model_t const *ui_model, ui_controller_t *ui_controller)
{
    ...
    ui_controller->m_ui_view = true;

    ui_controller->m_language_index = 0;

    ui_controller->m_show_renderer_manager = false;
    ...
    ui_controller->m_show_motion_receiver_manager = false;
    ...
    ui_controller->m_show_directional_lighting_manager = false;
    ...
    ui_controller->m_new_video_capture_enable_debug_renderer = false;
    ...
    ui_controller->m_new_video_detector_pose_confidence_threshold = 0.125F;
    ui_controller->m_new_video_detector_face_confidence_threshold = 0.125F;
    ui_controller->m_new_video_detector_hand_confidence_threshold = 0.125F;
    ...
    ui_controller->m_new_motion_receiver_port = 39539U;
    ui_controller->m_tree_view_selected_motion_receiver = INVALID_PORT;
    ...
    ui_controller->m_new_instance_model_selected_morph_motion_capture = INVALID_TIMESTAMP;
    ui_controller->m_new_instance_model_selected_morph_motion_capture_pose_index = BRX_MOTION_UINT32_INDEX_INVALID;
    ui_controller->m_new_instance_model_selected_morph_motion_capture_face_index = BRX_MOTION_UINT32_INDEX_INVALID;
    ui_controller->m_new_instance_model_selected_morph_motion_capture_hand_index = BRX_MOTION_UINT32_INDEX_INVALID;
    ui_controller->m_new_instance_model_selected_morph_instance_motion = INVALID_TIMESTAMP;
    ui_controller->m_new_instance_model_selected_morph_motion_receiver = INVALID_PORT;
    ui_controller->m_new_instance_model_joint_animation_input_type = ANIMATION_INPUT_TYPE_INVALID;
    ui_controller->m_new_instance_model_selected_joint_motion_capture = INVALID_TIMESTAMP;
    ui_controller->m_new_instance_model_selected_joint_motion_capture_pose_index = BRX_MOTION_UINT32_INDEX_INVALID;
    ui_controller->m_new_instance_model_selected_joint_motion_capture_face_index = BRX_MOTION_UINT32_INDEX_INVALID;
    ...
    ui_controller->m_new_instance_model_transform_rotation_w = 1.0F;
    ...
    ui_controller->m_new_area_lighting_position_x = -1.5F;
    ui_controller->m_new_area_lighting_position_y = 1.5F;
    ui_controller->m_new_area_lighting_position_z = 0.0F;
...
extern void ui_simulate(brx_anari_device *device, ui_model_t *ui_model, ui_controller_t *ui_controller)
{
    ...
    if (ui_controller->m_ui_view)
    {
        ...
        if (ImGui::Begin("Brioche Puppet (ESC Enable/Disable UI)", &ui_controller->m_ui_view))
        {
            {
            ...
            {
                if (ImGui::BeginTable("##Renderer-Manager-Display-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
                {
                    ImGui::TableSetupColumn("##Renderer-Manager-Display-Table-Property", ImGuiTableColumnFlags_WidthFixed);
                    ImGui::TableSetupColumn("##Renderer-Manager-Display-Table-Value", ImGuiTableColumnFlags_WidthStretch);
...

                    {
...

                        {
                            ...
                            ImGui::Combo("##Renderer-Manager-Display-Table-Value-Renderer-Style", &select_style, items[ui_controller->m_language_index], IM_ARRAYSIZE(items[0]));
...

            {
                if (ImGui::BeginTable("##Show-Manager-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
                {
                    ...
                    ImGui::TableNextColumn();
                    {
                        ImGui::Checkbox("##Show-Renderer-Manager", &ui_controller->m_show_renderer_manager);
                    }
                    ...
                    ImGui::TableNextColumn();
                    {
                        ImGui::Checkbox("##Show-Motion-Receiver-Manager", &ui_controller->m_show_motion_receiver_manager);
                    }
                    ...
                    ImGui::TableNextColumn();
                    {
                        ImGui::Checkbox("##Show-Directional-Lighting-Manager", &ui_controller->m_show_directional_lighting_manager);
                    }
    ...
    if (ui_controller->m_show_renderer_manager)
    {
        {
            ImGuiViewport const *const main_viewport = ImGui::GetMainViewport();
            ImGui::SetNextWindowPos(ImVec2(main_viewport->WorkPos.x + ui_x * ui_index, main_viewport->WorkPos.y + ui_y * ui_index), ImGuiCond_FirstUseEver);
        ...
        if (ImGui::Begin("Renderer Manager", &ui_controller->m_show_renderer_manager))
        {
            {
                constexpr char const *const text[LANGUAGE_COUNT] = {
                    "Renderer Manager",
            ...
            if (ImGui::BeginTable("##Renderer-Manager-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
            {
                ...
                ImGui::TableNextColumn();
                {
                    float renderer_background_rgb[3] = {ui_model->m_renderer_background_r, ui_model->m_renderer_background_g, ui_model->m_renderer_background_b};

                    ImGui::ColorEdit3("##Renderer-Manager-Table-Value-Background", renderer_background_rgb);

                    ui_model->m_renderer_background_r = renderer_background_rgb[0];
                    ui_model->m_renderer_background_g = renderer_background_rgb[1];
...
#undef _INTERNAL_BRX_X_STRINGIZING
    ...
    if (ui_controller->m_show_video_capture_manager)
    {
        ...
        if (ImGui::Begin("Video Capture Manager", &ui_controller->m_show_video_capture_manager))
        {
            {
                constexpr char const *const text[LANGUAGE_COUNT] = {
                    "Video Capture Manager",
                ...
                if (ImGui::TreeNodeEx("##Video-Capture-Manager-New-Node", ImGuiTreeNodeFlags_DefaultOpen | ImGuiTreeNodeFlags_Framed | ImGuiTreeNodeFlags_NoAutoOpenOnLog))
                {
                    if (ImGui::BeginTable("##Video-Capture-Manager-New-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
                    {
                        ...
                        ImGui::TableNextColumn();
                        {
                            ...
                            std::snprintf(&camera_index_text[0], sizeof(camera_index_text) / sizeof(camera_index_text[0]), "%lld", static_cast<long long>(std::max(0, ui_controller->m_new_video_capture_camera_index)));
                            ...
                            ui_controller->m_new_video_capture_camera_index = std::max(static_cast<long long>(0), std::strtoll(camera_index_text, NULL, 10));
                        }
                        ...
                        ImGui::TableNextColumn();
                        {
                            ImGui::Checkbox("##Video-Capture-Manager-New-Video-Capture-Enable-Debug-Renderer", &ui_controller->m_new_video_capture_enable_debug_renderer);
                        }
                ...
                if (ImGui::Button("N##Video-Capture-Manager-New-Button"))
                {
                    ...
                    if (ui_model->m_video_captures.end() == found_video_capture)
                    {
                        ...
                        if (NULL != video_capture)
                        {
                            ...
                            bool const enable_debug_renderer = ui_controller->m_new_video_capture_enable_debug_renderer;

                            video_capture->set_enable_debug_renderer(enable_debug_renderer, video_capture_identity.c_str());
            ...
            if (ui_model->m_video_captures.end() != found_video_capture)
            {
                ...
                if (ImGui::BeginTable("##Video-Capture-Manager-Right-Group-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
                {
                    ...
                    ImGui::TableNextColumn();
                    {
                        assert(NULL != found_video_capture->second.m_video_capture);

                        bool enable_debug_renderer = found_video_capture->second.m_video_capture->get_enable_debug_renderer();

                        ImGui::Checkbox("##Video-Capture-Manager-Right-Group-Table-Value-Enable-Debug-Renderer", &enable_debug_renderer);

                        found_video_capture->second.m_video_capture->set_enable_debug_renderer(enable_debug_renderer, found_video_capture->first.c_str());
                    }
    ...
    if (ui_controller->m_show_asset_motion_manager)
    {
        ...
        if (ImGui::Begin("Asset Motion Manager", &ui_controller->m_show_asset_motion_manager))
        {
    ...
    if (ui_controller->m_show_asset_model_manager)
    {
        ...
        if (ImGui::Begin("Asset Model Manager", &ui_controller->m_show_asset_model_manager))
        {
            {
                constexpr char const *const text[LANGUAGE_COUNT] = {
                    "Asset Model Manager",
    ...
    if (ui_controller->m_show_asset_image_manager)
    {
        ...
        if (ImGui::Begin("Asset Image Manager", &ui_controller->m_show_asset_image_manager))
        {
            {
                constexpr char const *const text[LANGUAGE_COUNT] = {
                    "Asset Image Manager",
    ...
    if (ui_controller->m_show_video_detector_manager)
    {
        ...
        if (ImGui::Begin("Video Detector Manager", &ui_controller->m_show_video_detector_manager))
        {
            {
                constexpr char const *const text[LANGUAGE_COUNT] = {
                    "Video Detector Manager",
                ...
                if (ImGui::BeginTable("##Video-Detector-Manager-New-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
                {
                    ...
                    ImGui::TableNextColumn();
                    {
                        constexpr char const *const hint[LANGUAGE_COUNT] = {
                            ...
                            "新建視訊檢測名稱",
                            "新建视频检测名称"};
                        ImGui::InputTextWithHint("##Video-Detector-Manager-New-Video-Detector-Name", hint[ui_controller->m_language_index], ui_controller->m_new_video_detector_name.data(), ui_controller->m_new_video_detector_name.size());
                    }
                    ...
                    ImGui::TableNextColumn();
                    {
                        float confidence_threshold = std::min(std::max(0.01F, ui_controller->m_new_video_detector_pose_confidence_threshold), 0.99F);

#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                        ImGui::SliderFloat("##Video-Detector-Manager-New-Video-Detector-Pose-Confidence-Threshold-Slider", &confidence_threshold, 0.01F, 0.99F, "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f");
                        ...
                        ImGui::SameLine();
                        {
                            ...
                            if (ImGui::BeginItemTooltip())
                            {
                                ImGui::PushTextWrapPos(help_marker_position);
                                constexpr char const *const text[LANGUAGE_COUNT] = {
                                    "If the pose can not be detected, you may lower the confidence threshold.",
                                    "姿勢を検出できない場合、信頼度閾値を下げることができます。",
                                    "如果無法檢測到姿勢，你可以降低置信度閾值。",
                                    "如果无法检测到姿势，你可以降低置信度阈值。"};
                                ImGui::TextUnformatted(text[ui_controller->m_language_index]);
                                ImGui::PopTextWrapPos();
                                ImGui::EndTooltip();
                            }
                        ...
                        char confidence_threshold_text[256];
                        std::snprintf(&confidence_threshold_text[0], sizeof(confidence_threshold_text) / sizeof(confidence_threshold_text[0]), "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f", confidence_threshold);
#undef _INTERNAL_BRX_STRINGIZING
#undef _INTERNAL_BRX_X_STRINGIZING
                        confidence_threshold_text[(sizeof(confidence_threshold_text) / sizeof(confidence_threshold_text[0]) - 1)] = '\0';

                        ImGui::InputText("##Video-Detector-Manager-New-Video-Detector-Pose-Confidence-Threshold-Roll-Text", &confidence_threshold_text[0], sizeof(confidence_threshold_text) / sizeof(confidence_threshold_text[0]), ImGuiInputTextFlags_CharsDecimal);

                        ui_controller->m_new_video_detector_pose_confidence_threshold = std::min(std::max(0.01F, std::strtof(confidence_threshold_text, NULL)), 0.99F);
                    }
                    ...
                    ImGui::TableNextColumn();
                    {
                        float confidence_threshold = std::min(std::max(0.01F, ui_controller->m_new_video_detector_face_confidence_threshold), 0.99F);

#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                        ImGui::SliderFloat("##Video-Detector-Manager-New-Video-Detector-Face-Confidence-Threshold-Slider", &confidence_threshold, 0.01F, 0.99F, "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f");
                        ...
                        ImGui::SameLine();
                        {
                            ...
                            if (ImGui::BeginItemTooltip())
                            {
                                ImGui::PushTextWrapPos(help_marker_position);
                                constexpr char const *const text[LANGUAGE_COUNT] = {
                                    "If the face can not be detected, you may lower the confidence threshold.",
                                    "人顔を検出できない場合、信頼度閾値を下げることができます。",
                                    "如果無法檢測到人臉，你可以降低置信度閾值。",
                                    "如果无法检测到人脸，你可以降低置信度阈值。"};
                                ImGui::TextUnformatted(text[ui_controller->m_language_index]);
                                ImGui::PopTextWrapPos();
                                ImGui::EndTooltip();
                            }
...
#undef _INTERNAL_BRX_X_STRINGIZING
                        ...
                        ImGui::InputText("##Video-Detector-Manager-New-Video-Detector-Face-Confidence-Threshold-Roll-Text", &confidence_threshold_text[0], sizeof(confidence_threshold_text) / sizeof(confidence_threshold_text[0]), ImGuiInputTextFlags_CharsDecimal);

                        ui_controller->m_new_video_detector_face_confidence_threshold = std::min(std::max(0.01F, std::strtof(confidence_threshold_text, NULL)), 0.99F);
                    }
                    ...
                    ImGui::TableNextColumn();
                    {
                        float confidence_threshold = std::min(std::max(0.01F, ui_controller->m_new_video_detector_hand_confidence_threshold), 0.99F);

#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                        ImGui::SliderFloat("##Video-Detector-Manager-New-Video-Detector-Hand-Confidence-Threshold-Slider", &confidence_threshold, 0.01F, 0.99F, "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f");
                        ...
                        ImGui::SameLine();
                        {
                            ...
                            if (ImGui::BeginItemTooltip())
                            {
                                ImGui::PushTextWrapPos(help_marker_position);
                                constexpr char const *const text[LANGUAGE_COUNT] = {
                                    "If the hand can not be detected, you may lower the confidence threshold.",
                                    "人手を検出できない場合、信頼度閾値を下げることができます。",
                                    "如果無法檢測到人手，你可以降低置信度閾值。",
                                    "如果无法检测到人手，你可以降低置信度阈值。"};
                                ImGui::TextUnformatted(text[ui_controller->m_language_index]);
                                ImGui::PopTextWrapPos();
                                ImGui::EndTooltip();
                            }
...
#undef _INTERNAL_BRX_X_STRINGIZING
                        ...
                        ImGui::InputText("##Video-Detector-Manager-New-Video-Detector-Hand-Confidence-Threshold-Roll-Text", &confidence_threshold_text[0], sizeof(confidence_threshold_text) / sizeof(confidence_threshold_text[0]), ImGuiInputTextFlags_CharsDecimal);

                        ui_controller->m_new_video_detector_hand_confidence_threshold = std::min(std::max(0.01F, std::strtof(confidence_threshold_text, NULL)), 0.99F);
                    }
                    ...
                    ImGui::SameLine();
                    {
                        ...
                        if (ImGui::BeginItemTooltip())
                        {
                            ImGui::PushTextWrapPos(help_marker_position);
                            constexpr char const *const text[LANGUAGE_COUNT] = {
                                "You may enable the debug renderer to check whether your pose, face, or hand can be detected.",
                                "調試描画機能を有効化し、姿勢・顔・手の検出可否を確認できます。",
                                "你可以啟用調試渲染器，以驗證是否能夠檢測到你的姿勢、人臉或人手。",
                                "你可以启用调试渲染器，以验证是否能够检测到你的姿势、人脸或人手。"};
                            ImGui::TextUnformatted(text[ui_controller->m_language_index]);
                            ImGui::PopTextWrapPos();
                            ImGui::EndTooltip();
                        }
                ...
                if (ImGui::Button("N##Video-Detector-Manager-New-Button"))
                {
                    ...
                    if (ui_model->m_video_captures.end() != found_video_capture)
                    {
                        ...
                        if (NULL != video_capture)
                        {
                            ...
                            float const pose_confidence_threshold = ui_controller->m_new_video_detector_pose_confidence_threshold;

                            float const face_confidence_threshold = ui_controller->m_new_video_detector_face_confidence_threshold;

                            float const hand_confidence_threshold = ui_controller->m_new_video_detector_hand_confidence_threshold;
                            ...
                            brx_motion_video_detector *const video_detector = brx_motion_create_video_detector(pose_count, face_count, hand_count, pose_confidence_threshold, face_confidence_threshold, hand_confidence_threshold, force_gpu, video_capture);
            ...
            if (ImGui::BeginChild("##Video-Detector-Manager-Left-Child", ImVec2(ui_width * left_child_width_ratio, 0.0F), ImGuiChildFlags_Borders | ImGuiChildFlags_ResizeX))
            {
                ...
                ImGuiTextFilter text_filter;
                {
                    constexpr char const *const hint[LANGUAGE_COUNT] = {
                        ...
                        "檢索",
                        "检索"};
                    if (ImGui::InputTextWithHint("##Video-Detector-Manager-Left-Child-Text-Filter", hint[ui_controller->m_language_index], text_filter.InputBuf, IM_ARRAYSIZE(text_filter.InputBuf), ImGuiInputTextFlags_EscapeClearsAll))
                    {
                        text_filter.Build();
                    }
                }
                ...
                if (ImGui::BeginTable("##Video-Detector-Manager-Left-Child-Table", 1, ImGuiTableFlags_RowBg))
                {
            ...
            if (ui_model->m_video_detectors.end() != found_video_detector)
            {
                ...
                if (ImGui::BeginTable("##Video-Detector-Manager-Right-Group-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
                {
                    ...
                    ImGui::TableNextColumn();
                    {
                        ...
                        std::snprintf(pose_count_timestamp_text, sizeof(pose_count_timestamp_text) / sizeof(pose_count_timestamp_text[0]), "%llu", static_cast<long long unsigned>(found_video_detector->second.m_video_detector->get_motion_capture()->get_pose_count()));
                    ...
                    ImGui::TableNextColumn();
                    {
                        ...
                        std::snprintf(face_count_timestamp_text, sizeof(face_count_timestamp_text) / sizeof(face_count_timestamp_text[0]), "%llu", static_cast<long long unsigned>(found_video_detector->second.m_video_detector->get_motion_capture()->get_face_count()));
                    ...
                    ImGui::TableNextColumn();
                    {
                        ...
                        std::snprintf(hand_count_timestamp_text, sizeof(hand_count_timestamp_text) / sizeof(hand_count_timestamp_text[0]), "%llu", static_cast<long long unsigned>(found_video_detector->second.m_video_detector->get_motion_capture()->get_hand_count()));
                    ...
                    ImGui::TableNextColumn();
                    {
                        ...
                        float confidence_threshold = found_video_detector->second.m_video_detector->get_pose_confidence_threshold();
...
#undef _INTERNAL_BRX_X_STRINGIZING
                        ...
                        ImGui::PushStyleColor(ImGuiCol_Text, ImGui::GetStyle().Colors[ImGuiCol_TextDisabled]);
                        ImGui::TextUnformatted(confidence_threshold_text);
                        ImGui::PopStyleColor();
                    }
                    ImGui::SameLine();
                    {
                    ...
                    ImGui::TableNextColumn();
                    {
                        ...
                        float confidence_threshold = found_video_detector->second.m_video_detector->get_face_confidence_threshold();
...
#undef _INTERNAL_BRX_X_STRINGIZING
                    ...
                    ImGui::TableNextColumn();
                    {
                        ...
                        float confidence_threshold = found_video_detector->second.m_video_detector->get_hand_confidence_threshold();
...
#undef _INTERNAL_BRX_X_STRINGIZING
    ...
    if (ui_controller->m_show_instance_motion_manager)
    {
        ...
        if (ImGui::Begin("Instance Motion Manager", &ui_controller->m_show_instance_motion_manager))
        {
            {
                constexpr char const *const text[LANGUAGE_COUNT] = {
                    "Instance Motion Manager",
...

            {
                ...
                if (ImGui::Button("N##Instance-Motion-Manager-New"))
                {
                    ...
                    uint32_t const selected_animation_index = ui_controller->m_new_instance_motion_selected_animation_index;
    ...
    if (ui_controller->m_show_motion_receiver_manager)
    {
        {
            ImGuiViewport const *const main_viewport = ImGui::GetMainViewport();
            ImGui::SetNextWindowPos(ImVec2(main_viewport->WorkPos.x + ui_x * ui_index, main_viewport->WorkPos.y + ui_y * ui_index), ImGuiCond_FirstUseEver);
        ...
        if (ImGui::Begin("Motion Receiver Manager", &ui_controller->m_show_motion_receiver_manager))
        {
            {
                ImGui::Separator();
                constexpr char const *const text[LANGUAGE_COUNT] = {
            ...
            if (ImGui::TreeNodeEx("##Motion-Receiver-Manager-New-Node", ImGuiTreeNodeFlags_DefaultOpen | ImGuiTreeNodeFlags_Framed | ImGuiTreeNodeFlags_NoAutoOpenOnLog))
            {
                if (ImGui::BeginTable("##Motion-Receiver-Manager-New-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
                {
                    ImGui::TableSetupColumn("##Motion-Receiver-Manager-New-Table-Property", ImGuiTableColumnFlags_WidthFixed);
                    ImGui::TableSetupColumn("##Motion-Receiver-Manager-New-Table-Value", ImGuiTableColumnFlags_WidthStretch);
                    ...
                    ImGui::TableNextColumn();
                    {
                        int port = std::min(std::max(1024, static_cast<int>(ui_controller->m_new_motion_receiver_port)), 49151);

                        ImGui::SliderInt("##Motion-Receiver-Manager-New-Motion-Receiver-Port-Slider", &port, 1024, 49151);

                        // ImGui::SameLine();

                        // ImGui::SetNextItemWidth(ImGui::GetContentRegionAvail().x * table_column_same_line_ratio);

                        char port_text[] = {"18446744073709551615"};
                        std::snprintf(port_text, sizeof(port_text) / sizeof(port_text[0]), "%lld", static_cast<long long>(port));
                        port_text[(sizeof(port_text) / sizeof(port_text[0])) - 1] = '\0';

                        ImGui::InputText("##Motion-Receiver-Manager-New-Motion-Receiver-Port-Text", &port_text[0], sizeof(port_text) / sizeof(port_text[0]), ImGuiInputTextFlags_CharsDecimal);

                        ui_controller->m_new_motion_receiver_port = std::min(std::max(static_cast<long long>(1024), std::strtoll(port_text, NULL, 10)), static_cast<long long>(49151));
                    }
...

            {
                ...
                if (ImGui::Button("N##Motion-Receiver-Manager-New-Button"))
                {
                    auto const found_motion_receiver = ui_model->m_motion_receivers.find(ui_controller->m_new_motion_receiver_port);
                    if (ui_model->m_motion_receivers.end() == found_motion_receiver)
                    {
                        brx_motion_motion_receiver *const motion_receiver = brx_motion_create_motion_receiver(ui_controller->m_new_motion_receiver_port);
                        if (NULL != motion_receiver)
                        {
                            ui_model->m_motion_receivers.insert(found_motion_receiver, std::pair<uint16_t, ui_motion_receiver_model_t>{ui_controller->m_new_motion_receiver_port, ui_motion_receiver_model_t{motion_receiver}});
                        }
                    }
                }
            }
...

            {
                ...
                if (ImGui::Button("X##Motion-Receiver-Manager-Delete"))
                {
                    auto const found_motion_receiver = ui_model->m_motion_receivers.find(ui_controller->m_tree_view_selected_motion_receiver);
                    if (ui_model->m_motion_receivers.end() != found_motion_receiver)
                    {
                        if (NULL != found_motion_receiver->second.m_motion_receiver)
                        {
                            brx_motion_destroy_motion_receiver(found_motion_receiver->second.m_motion_receiver);
                            found_motion_receiver->second.m_motion_receiver = NULL;
                        }
                        else
                        {
                            assert(false);
                        ...
                        ui_model->m_motion_receivers.erase(found_motion_receiver);
                        ui_controller->m_tree_view_selected_motion_receiver = INVALID_PORT;
                    }
                }
            }
            ...
            if (ImGui::BeginChild("##Motion-Receiver-Manager-Left-Child", ImVec2(ui_width * left_child_width_ratio, 0.0F), ImGuiChildFlags_Borders | ImGuiChildFlags_ResizeX))
            {
                ImGui::SetNextItemWidth(-FLT_MIN);
                ImGui::PushItemFlag(ImGuiItemFlags_NoNavDefaultFocus, true);
                ImGuiTextFilter text_filter;
                {
                    constexpr char const *const hint[LANGUAGE_COUNT] = {
                        ...
                        "檢索",
                        "检索"};
                    if (ImGui::InputTextWithHint("##Motion-Receiver-Manager-Left-Child-Text-Filter", hint[ui_controller->m_language_index], text_filter.InputBuf, IM_ARRAYSIZE(text_filter.InputBuf), ImGuiInputTextFlags_EscapeClearsAll))
                    {
                        text_filter.Build();
                    }
                }
                ...
                if (ImGui::BeginTable("##Motion-Receiver-Manager-Left-Child-Table", 1, ImGuiTableFlags_RowBg))
                {
                    for (auto const &motion_receiver : ui_model->m_motion_receivers)
                    {
                        mcrt_string motion_receiver_identity;
                        {
                            char motion_receiver_port_text[] = {"18446744073709551615"};
                            std::snprintf(motion_receiver_port_text, sizeof(motion_receiver_port_text) / sizeof(motion_receiver_port_text[0]), "%lld", static_cast<long long>(motion_receiver.first));
                            motion_receiver_port_text[(sizeof(motion_receiver_port_text) / sizeof(motion_receiver_port_text[0])) - 1] = '\0';

                            motion_receiver_identity += motion_receiver_port_text;
                        }

                        if (text_filter.PassFilter(motion_receiver_identity.c_str()))
                        {
                            ImGui::TableNextRow();
                            ImGui::TableNextColumn();

                            ImGuiTreeNodeFlags const flags = ((ui_controller->m_tree_view_selected_motion_receiver != motion_receiver.first)) ? ImGuiTreeNodeFlags_Leaf : (ImGuiTreeNodeFlags_Leaf | ImGuiTreeNodeFlags_Selected);

                            bool const node_open = ImGui::TreeNodeEx(motion_receiver_identity.c_str(), flags);

                            if (ImGui::IsItemFocused())
                            {
                                ui_controller->m_tree_view_selected_motion_receiver = motion_receiver.first;
                            }
            ...
            if (ui_model->m_motion_receivers.end() != found_motion_receiver)
            {
                ...
                if (ImGui::BeginTable("##Motion-Receiver-Manager-Right-Group-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
                {
                    ImGui::TableSetupColumn("##Motion-Receiver-Manager-Right-Group-Table-Property", ImGuiTableColumnFlags_WidthFixed);
                    ImGui::TableSetupColumn("##Motion-Receiver-Manager-Right-Group-Table-Value", ImGuiTableColumnFlags_WidthStretch);
                    ...
                    {
                        char motion_receiver_port_text[] = {"18446744073709551615"};
                        std::snprintf(motion_receiver_port_text, sizeof(motion_receiver_port_text) / sizeof(motion_receiver_port_text[0]), "%lld", static_cast<long long>(found_motion_receiver->first));
                        motion_receiver_port_text[(sizeof(motion_receiver_port_text) / sizeof(motion_receiver_port_text[0])) - 1] = '\0';

                        ImGui::PushStyleColor(ImGuiCol_Text, ImGui::GetStyle().Colors[ImGuiCol_TextDisabled]);
                        ImGui::TextUnformatted(motion_receiver_port_text);
                        ImGui::PopStyleColor();
                    }
    ...
    if (ui_controller->m_show_instance_model_manager)
    {
        ...
        if (ImGui::Begin("Instance Model Manager", &ui_controller->m_show_instance_model_manager))
        {
            {
                constexpr char const *const text[LANGUAGE_COUNT] = {
                    "Instance Model Manager",
            ...
            if (ImGui::TreeNodeEx("##Instance-Model-Manager-New-Node", ImGuiTreeNodeFlags_DefaultOpen | ImGuiTreeNodeFlags_Framed | ImGuiTreeNodeFlags_NoAutoOpenOnLog))
            {
                ...
                if (ImGui::BeginTable("##Instance-Model-Manager-New-Morph-Animation-Input-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
                {
                    ...
                    ImGui::TableNextColumn();
                    {
                        constexpr char const *const items[LANGUAGE_COUNT][ANIMATION_INPUT_TYPE_COUNT] = {
                            {"Disable", "Video Detector", "Instance Motion", "Motion Receiver"},
                            {"無効", "動画検出", "実例行動", "動画受信"},
                            {"停用", "視訊檢測", "實例動作", "動作接收"},
                            {"停用", "视频检测", "实例动作", "动作接收"}};
                    ...
                    if (ANIMATION_INPUT_TYPE_VIDEO_DETECTOR == ui_controller->m_new_instance_model_morph_animation_input_type)
                    {
                        ...
                        ImGui::TableNextColumn();
                        {
                            ...
                            int selected_combo_index = 0;
                            {
...

                                {
                                    ...
                                    if (ui_controller->m_new_instance_model_selected_morph_motion_capture == item_values[combo_index])
                                    {
                                        assert(0 == selected_combo_index);
                                ...
                                for (auto const &video_detector : ui_model->m_video_detectors)
                                {
                                    ...
                                    if (ui_controller->m_new_instance_model_selected_morph_motion_capture == item_values[combo_index])
                                    {
                                        ...
                                        assert(INVALID_PORT == ui_controller->m_new_instance_model_selected_morph_motion_receiver);
                                    }
                            ...
                            if (selected_combo_index >= 0)
                            {
                                ui_controller->m_new_instance_model_selected_morph_motion_capture = item_values[selected_combo_index];
                                ui_controller->m_new_instance_model_selected_morph_instance_motion = INVALID_TIMESTAMP;
                                ui_controller->m_new_instance_model_selected_morph_motion_receiver = INVALID_PORT;
                            }
                            else
                        ...
                        {
                            auto const found_video_detector = ui_model->m_video_detectors.find(ui_controller->m_new_instance_model_selected_morph_motion_capture);
                            ...
                            ImGui::TableNextColumn();
                            {
                                ...
                                if (ui_model->m_video_detectors.end() != found_video_detector)
                                {
                                    ...
                                    uint32_t const pose_count = found_video_detector->second.m_video_detector->get_motion_capture()->get_pose_count();
                                    ...
                                    if (pose_count > 0U)
                                    {
                                        ...
                                        int selected_combo_index = 0;
                                        {
                                            ...
                                            for (uint32_t pose_index = 0U; pose_index < pose_count; ++pose_index)
                                            {
                                                ...
                                                if (ui_controller->m_new_instance_model_selected_morph_motion_capture_pose_index == item_values[combo_index])
                                                {
                                                    assert(0 == selected_combo_index);
                                                    assert(static_cast<size_t>(1U + combo_index) < static_cast<size_t>(INT_MAX));
                                                    selected_combo_index = static_cast<int>(combo_index);
                                        ...
                                        if (selected_combo_index >= 0)
                                        {
                                            ui_controller->m_new_instance_model_selected_morph_motion_capture_pose_index = item_values[selected_combo_index];
                                        }
                                        else
                                        {
                                            assert(false);
                            ...
                            ImGui::TableNextColumn();
                            {
                                ...
                                if (ui_model->m_video_detectors.end() != found_video_detector)
                                {
                                    ...
                                    uint32_t const face_count = found_video_detector->second.m_video_detector->get_motion_capture()->get_face_count();
                                    ...
                                    if (face_count > 0U)
                                    {
                                        ...
                                        int selected_combo_index = 0;
                                        {
                                            ...
                                            for (uint32_t face_index = 0U; face_index < face_count; ++face_index)
                                            {
                                                ...
                                                if (ui_controller->m_new_instance_model_selected_morph_motion_capture_face_index == item_values[combo_index])
                                                {
                                                    assert(0 == selected_combo_index);
                                                    assert(static_cast<size_t>(1U + combo_index) < static_cast<size_t>(INT_MAX));
                                                    selected_combo_index = static_cast<int>(combo_index);
                                        ...
                                        if (selected_combo_index >= 0)
                                        {
                                            ui_controller->m_new_instance_model_selected_morph_motion_capture_face_index = item_values[selected_combo_index];
                                        }
                                        else
                                        {
                                            assert(false);
                            ...
                            ImGui::TableNextColumn();
                            {
                                ...
                                if (ui_model->m_video_detectors.end() != found_video_detector)
                                {
                                    ...
                                    uint32_t const hand_count = found_video_detector->second.m_video_detector->get_motion_capture()->get_hand_count();
                                    ...
                                    if (hand_count > 0U)
                                    {
                                        ...
                                        int selected_combo_index = 0;
                                        {
                                            ...
                                            for (uint32_t hand_index = 0U; hand_index < hand_count; ++hand_index)
                                            {
                                                ...
                                                if (ui_controller->m_new_instance_model_selected_morph_motion_capture_hand_index == item_values[combo_index])
                                                {
                                                    assert(0 == selected_combo_index);
                                                    assert(static_cast<size_t>(1U + combo_index) < static_cast<size_t>(INT_MAX));
                                                    selected_combo_index = static_cast<int>(combo_index);
                                        ...
                                        if (selected_combo_index >= 0)
                                        {
                                            ui_controller->m_new_instance_model_selected_morph_motion_capture_hand_index = item_values[selected_combo_index];
                                        }
                                        else
                                        {
                                            assert(false);
                            ...
                            int selected_combo_index = 0;
                            {
                                ...
                                for (auto const &instance_motion : ui_model->m_instance_motions)
                                {
                                    ...
                                    if (ui_controller->m_new_instance_model_selected_morph_instance_motion == item_values[combo_index])
                                    {
                                        ...
                                        assert((1U + combo_index) < static_cast<size_t>(INT_MAX));
                                        selected_combo_index = static_cast<int>(combo_index);
                                        assert(INVALID_TIMESTAMP == ui_controller->m_new_instance_model_selected_morph_motion_capture);
                                        assert(INVALID_PORT == ui_controller->m_new_instance_model_selected_morph_motion_receiver);
                                    }
                    ...
                    else if (ANIMATION_INPUT_TYPE_MOTION_RECEIVER == ui_controller->m_new_instance_model_morph_animation_input_type)
                    {
                        ImGui::TableNextRow();
                        ImGui::TableNextColumn();
                        ImGui::AlignTextToFramePadding();
                        ...
                        ImGui::TableNextColumn();
                        {
                            mcrt_vector<uint64_t> item_values(static_cast<size_t>(ui_model->m_motion_receivers.size() + 1U));
                            mcrt_vector<mcrt_string> item_strings(static_cast<size_t>(ui_model->m_motion_receivers.size() + 1U));
                            mcrt_vector<char const *> items(static_cast<size_t>(ui_model->m_motion_receivers.size() + 1U));
                            int selected_combo_index = 0;
                            {
                                size_t combo_index = 0U;

                                {
                                    item_values[combo_index] = INVALID_PORT;
                                    ...
                                    if (ui_controller->m_new_instance_model_selected_morph_motion_receiver == item_values[combo_index])
                                    {
                                        assert(0 == selected_combo_index);
                                        assert(0 == combo_index);
                                    }
                                ...
                                for (auto const &motion_receiver : ui_model->m_motion_receivers)
                                {
                                    item_values[combo_index] = motion_receiver.first;

                                    item_strings[combo_index].clear();
                                    {
                                        char item_value_text[] = {"18446744073709551615"};
                                        std::snprintf(item_value_text, sizeof(item_value_text) / sizeof(item_value_text[0]), "%lld", static_cast<long long>(item_values[combo_index]));
                                        item_value_text[(sizeof(item_value_text) / sizeof(item_value_text[0])) - 1] = '\0';
                            ...
                            ImGui::Combo("##Instance-Model-Manager-New-Morph-Animation-Input-Table-Select-Morph-Motion-Receiver", &selected_combo_index, items.data(), items.size());

                            if (selected_combo_index >= 0)
                            {
                                ui_controller->m_new_instance_model_selected_morph_motion_receiver = item_values[selected_combo_index];
                                ui_controller->m_new_instance_model_selected_morph_motion_capture = INVALID_TIMESTAMP;
                                ui_controller->m_new_instance_model_selected_morph_instance_motion = INVALID_TIMESTAMP;
                            }
                            else
                ...
                if (ImGui::BeginTable("##Instance-Model-Manager-New-Joint-Animation-Input-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
                {
                    ...
                    if (ANIMATION_INPUT_TYPE_VIDEO_DETECTOR == ui_controller->m_new_instance_model_joint_animation_input_type)
                    {
                        ...
                        ImGui::TableNextColumn();
                        {
                            ...
                            int selected_combo_index = 0;
                            {
...

                                {
                                    ...
                                    if (ui_controller->m_new_instance_model_selected_joint_motion_capture == item_values[combo_index])
                                    {
                                        assert(0 == selected_combo_index);
                                        assert(0 == combo_index);
                                    }
                                ...
                                for (auto const &video_detector : ui_model->m_video_detectors)
                                {
                                    ...
                                    if (ui_controller->m_new_instance_model_selected_joint_motion_capture == item_values[combo_index])
                                    {
                                        ...
                                        assert(INVALID_PORT == ui_controller->m_new_instance_model_selected_joint_motion_receiver);
                                    }
                            ...
                            if (selected_combo_index >= 0)
                            {
                                ui_controller->m_new_instance_model_selected_joint_motion_capture = item_values[selected_combo_index];
                                ui_controller->m_new_instance_model_selected_joint_instance_motion = INVALID_TIMESTAMP;
                                ui_controller->m_new_instance_model_selected_joint_motion_receiver = INVALID_PORT;
                            }
                            else
                        ...
                        {
                            auto const found_video_detector = ui_model->m_video_detectors.find(ui_controller->m_new_instance_model_selected_joint_motion_capture);
                                    ...
                                    if (pose_count > 0U)
                                    {
                                        ...
                                        int selected_combo_index = 0;
                                        {
                                            ...
                                            for (uint32_t pose_index = 0U; pose_index < pose_count; ++pose_index)
                                            {
                                                ...
                                                if (ui_controller->m_new_instance_model_selected_joint_motion_capture_pose_index == item_values[combo_index])
                                                {
                                                    assert(0 == selected_combo_index);
                                                    assert(static_cast<size_t>(1U + combo_index) < static_cast<size_t>(INT_MAX));
                                                    selected_combo_index = static_cast<int>(combo_index);
                                        ...
                                        if (selected_combo_index >= 0)
                                        {
                                            ui_controller->m_new_instance_model_selected_joint_motion_capture_pose_index = item_values[selected_combo_index];
                                        }
                                        else
                                        {
                                            assert(false);
                                    ...
                                    if (face_count > 0U)
                                    {
                                        ...
                                        int selected_combo_index = 0;
                                        {
                                            ...
                                            for (uint32_t face_index = 0U; face_index < face_count; ++face_index)
                                            {
                                                ...
                                                if (ui_controller->m_new_instance_model_selected_joint_motion_capture_face_index == item_values[combo_index])
                                                {
                                                    assert(0 == selected_combo_index);
                                                    assert(static_cast<size_t>(1U + combo_index) < static_cast<size_t>(INT_MAX));
                                                    selected_combo_index = static_cast<int>(combo_index);
                                        ...
                                        if (selected_combo_index >= 0)
                                        {
                                            ui_controller->m_new_instance_model_selected_joint_motion_capture_face_index = item_values[selected_combo_index];
                                        }
                                        else
                                        {
                                            assert(false);
                                    ...
                                    if (hand_count > 0U)
                                    {
                                        ...
                                        int selected_combo_index = 0;
                                        {
                                            ...
                                            for (uint32_t hand_index = 0U; hand_index < hand_count; ++hand_index)
                                            {
                                                ...
                                                if (ui_controller->m_new_instance_model_selected_joint_motion_capture_hand_index == item_values[combo_index])
                                                {
                                                    assert(0 == selected_combo_index);
                                                    assert(static_cast<size_t>(1U + combo_index) < static_cast<size_t>(INT_MAX));
                                                    selected_combo_index = static_cast<int>(combo_index);
                                        ...
                                        if (selected_combo_index >= 0)
                                        {
                                            ui_controller->m_new_instance_model_selected_joint_motion_capture_hand_index = item_values[selected_combo_index];
                                        }
                                        else
                                        {
                                            assert(false);
                            ...
                            int selected_combo_index = 0;
                            {
                                ...
                                for (auto const &instance_motion : ui_model->m_instance_motions)
                                {
                                    ...
                                    if (ui_controller->m_new_instance_model_selected_joint_instance_motion == item_values[combo_index])
                                    {
                                        ...
                                        assert((1U + combo_index) < static_cast<size_t>(INT_MAX));
                                        selected_combo_index = static_cast<int>(combo_index);
                                        assert(INVALID_TIMESTAMP == ui_controller->m_new_instance_model_selected_joint_motion_capture);
                                        assert(INVALID_PORT == ui_controller->m_new_instance_model_selected_joint_motion_receiver);
                                    }
                    ...
                    else if (ANIMATION_INPUT_TYPE_MOTION_RECEIVER == ui_controller->m_new_instance_model_joint_animation_input_type)
                    {
                        ImGui::TableNextRow();
                        ImGui::TableNextColumn();
                        ImGui::AlignTextToFramePadding();
                        ...
                        ImGui::TableNextColumn();
                        {
                            ...
                            int selected_combo_index = 0;
                            {
...

                                {
                                    ...
                                    if (ui_controller->m_new_instance_model_selected_joint_motion_receiver == item_values[combo_index])
                                    {
                                        assert(0 == selected_combo_index);
                                        assert(0 == combo_index);
                                    }
                            ...
                            ImGui::Combo("##Instance-Model-Manager-New-Joint-Animation-Input-Table-Select-Joint-Motion-Receiver", &selected_combo_index, items.data(), items.size());

                            if (selected_combo_index >= 0)
                            {
                                ui_controller->m_new_instance_model_selected_joint_motion_receiver = item_values[selected_combo_index];
                                ui_controller->m_new_instance_model_selected_joint_motion_capture = INVALID_TIMESTAMP;
                                ui_controller->m_new_instance_model_selected_joint_instance_motion = INVALID_TIMESTAMP;
                            }
                            else
                    ...
                    ImGui::TableNextColumn();
                    {
                        ImGui::Checkbox("##Instance-Model-Manager-New-Joint-Animation-Input-Table-Value-Enable-Root-Motion", &ui_controller->m_new_instance_model_enable_root_motion);
                    }
                ...
                if (ImGui::BeginTable("##Instance-Model-Manager-New-Model-Transform-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
                {
...

                    {
                        ...
                        ImGui::TableNextColumn();
                        {
                            ...
                            float rotation = std::min(std::max(-1.0F, ui_controller->m_new_instance_model_transform_rotation_x), 1.0F);
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                            ImGui::SliderFloat("##Instance-Model-Manager-New-Model-Transform-Table-Rotation-Quaternion-X-Slider", &rotation, -1.0F, 1.0F, "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f");
...
#undef _INTERNAL_BRX_X_STRINGIZING
                            ...
                            ImGui::InputText("##Instance-Model-Manager-New-Model-Transform-Table-Rotation-Quaternion-X-Text", &rotation_text[0], sizeof(rotation_text) / sizeof(rotation_text[0]), ImGuiInputTextFlags_CharsDecimal);

                            ui_controller->m_new_instance_model_transform_rotation_x = std::min(std::max(-1.0F, std::strtof(rotation_text, NULL)), 1.0F);
                        }
                        ...
                        ImGui::TableNextColumn();
                        {
                            float rotation = std::min(std::max(-1.0F, ui_controller->m_new_instance_model_transform_rotation_y), 1.0F);
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                            ImGui::SliderFloat("##Instance-Model-Manager-New-Model-Transform-Table-Rotation-Quaternion-Y-Slider", &rotation, -1.0F, 1.0F, "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f");
...
#undef _INTERNAL_BRX_X_STRINGIZING
                            ...
                            ImGui::InputText("##Instance-Model-Manager-New-Model-Transform-Table-Rotation-Quaternion-Y-Text", &rotation_text[0], sizeof(rotation_text) / sizeof(rotation_text[0]), ImGuiInputTextFlags_CharsDecimal);

                            ui_controller->m_new_instance_model_transform_rotation_y = std::min(std::max(-1.0F, std::strtof(rotation_text, NULL)), 1.0F);
                        }
                        ...
                        ImGui::TableNextColumn();
                        {
                            float rotation = std::min(std::max(-1.0F, ui_controller->m_new_instance_model_transform_rotation_z), 1.0F);
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                            ImGui::SliderFloat("##Instance-Model-Manager-New-Model-Transform-Table-Rotation-Quaternion-Z-Slider", &rotation, -1.0F, 1.0F, "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f");
...
#undef _INTERNAL_BRX_X_STRINGIZING
                            ...
                            ImGui::InputText("##Instance-Model-Manager-New-Model-Transform-Table-Rotation-Quaternion-Z-Text", &rotation_text[0], sizeof(rotation_text) / sizeof(rotation_text[0]), ImGuiInputTextFlags_CharsDecimal);

                            ui_controller->m_new_instance_model_transform_rotation_z = std::min(std::max(-1.0F, std::strtof(rotation_text, NULL)), 1.0F);
                        }
                        ...
                        ImGui::TableNextColumn();
                        {
                            float rotation = std::min(std::max(-1.0F, ui_controller->m_new_instance_model_transform_rotation_w), 1.0F);
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                            ImGui::SliderFloat("##Instance-Model-Manager-New-Model-Transform-Table-Rotation-Quaternion-W-Slider", &rotation, -1.0F, 1.0F, "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f");
...
#undef _INTERNAL_BRX_X_STRINGIZING
                            ...
                            ImGui::InputText("##Instance-Model-Manager-New-Model-Transform-Table-Rotation-Quaternion-W-Text", &rotation_text[0], sizeof(rotation_text) / sizeof(rotation_text[0]), ImGuiInputTextFlags_CharsDecimal);

                            ui_controller->m_new_instance_model_transform_rotation_w = std::min(std::max(-1.0F, std::strtof(rotation_text, NULL)), 1.0F);
                        }

                        {
                            DirectX::XMFLOAT4 const directx_rotation_quaternion(ui_controller->m_new_instance_model_transform_rotation_x, ui_controller->m_new_instance_model_transform_rotation_y, ui_controller->m_new_instance_model_transform_rotation_z, ui_controller->m_new_instance_model_transform_rotation_w);

                            DirectX::XMFLOAT4 directx_normalized_rotation_quaternion;
                            DirectX::XMStoreFloat4(&directx_normalized_rotation_quaternion, DirectX::XMQuaternionNormalize(DirectX::XMLoadFloat4(&directx_rotation_quaternion)));
                            ui_controller->m_new_instance_model_transform_rotation_x = directx_normalized_rotation_quaternion.x;
                            ui_controller->m_new_instance_model_transform_rotation_y = directx_normalized_rotation_quaternion.y;
                            ui_controller->m_new_instance_model_transform_rotation_z = directx_normalized_rotation_quaternion.z;
                            ui_controller->m_new_instance_model_transform_rotation_w = directx_normalized_rotation_quaternion.w;
                        }
                    }
...
#undef _INTERNAL_BRX_X_STRINGIZING
                    ...
                    if ((ui_model->m_asset_models.end() != found_asset_model) && (surface_group_index < found_asset_model->second.m_surface_groups.size()) && (surface_group_index < found_asset_model->second.m_skeletons.size()))
                    {
                        ...
                        if (NULL != surface_group)
                        {
                            ...
                            if ((NULL != surface_group_instance) && ((!skeleton) || (NULL != skeleton_instance)))
                            {
                                ...
                                uint64_t morph_motion_capture = INVALID_TIMESTAMP;
                                uint64_t morph_instance_motion = INVALID_TIMESTAMP;
                                uint16_t morph_motion_receiver = INVALID_PORT;

                                ANIMATION_INPUT_TYPE joint_animation_input_type = ANIMATION_INPUT_TYPE_INVALID;
                                uint64_t joint_motion_capture = INVALID_TIMESTAMP;
                                uint64_t joint_instance_motion = INVALID_TIMESTAMP;
                                uint16_t joint_motion_receiver = INVALID_PORT;
                                ...
                                if ((NULL != skeleton) && (NULL != skeleton_instance))
                                {
                                    ...
                                    morph_motion_capture = ui_controller->m_new_instance_model_selected_morph_motion_capture;

                                    uint32_t const morph_motion_capture_pose_index = ui_controller->m_new_instance_model_selected_morph_motion_capture_pose_index;

                                    uint32_t const morph_motion_capture_face_index = ui_controller->m_new_instance_model_selected_morph_motion_capture_face_index;

                                    uint32_t const morph_motion_capture_hand_index = ui_controller->m_new_instance_model_selected_morph_motion_capture_hand_index;

                                    morph_instance_motion = ui_controller->m_new_instance_model_selected_morph_instance_motion;

                                    morph_motion_receiver = ui_controller->m_new_instance_model_selected_morph_motion_receiver;

                                    auto const found_morph_motion_capture = ui_model->m_video_detectors.find(morph_motion_capture);

                                    auto const found_morph_instance_motion = ui_model->m_instance_motions.find(morph_instance_motion);

                                    auto const found_morph_motion_receiver = ui_model->m_motion_receivers.find(morph_motion_receiver);

                                    assert((ui_model->m_video_detectors.end() == found_morph_motion_capture) || (ui_model->m_instance_motions.end() == found_morph_instance_motion) || (ui_model->m_motion_receivers.end() == found_morph_motion_receiver));

                                    if (ui_model->m_video_detectors.end() != found_morph_motion_capture)
                                    {
                                        assert(NULL != found_morph_motion_capture->second.m_video_detector);

                                        skeleton_instance->set_morph_input_motion_capture(found_morph_motion_capture->second.m_video_detector->get_motion_capture());
                                        skeleton_instance->set_morph_input_motion_capture_pose_index(morph_motion_capture_pose_index);
                                        skeleton_instance->set_morph_input_motion_capture_face_index(morph_motion_capture_face_index);
                                        skeleton_instance->set_morph_input_motion_capture_hand_index(morph_motion_capture_hand_index);

                                        assert(INVALID_TIMESTAMP == morph_instance_motion);
                                        assert(INVALID_PORT == morph_motion_receiver);
                                    ...
                                    else if (ui_model->m_instance_motions.end() != found_morph_instance_motion)
                                    {
                                        ...
                                        assert(INVALID_TIMESTAMP == morph_motion_capture);
                                        assert(INVALID_PORT == morph_motion_receiver);

                                        assert(ANIMATION_INPUT_TYPE_INSTANCE_MOTION == morph_animation_input_type);
                                    }
                                    else if (ui_model->m_motion_receivers.end() != found_morph_motion_receiver)
                                    {
                                        assert(NULL != found_morph_motion_receiver->second.m_motion_receiver);

                                        skeleton_instance->set_morph_input_motion_capture(found_morph_motion_receiver->second.m_motion_receiver->get_motion_capture());
                                        skeleton_instance->set_morph_input_motion_capture_pose_index(0U);
                                        skeleton_instance->set_morph_input_motion_capture_face_index(0U);
                                        skeleton_instance->set_morph_input_motion_capture_hand_index(0U);

                                        assert(INVALID_TIMESTAMP == morph_motion_capture);
                                        assert(INVALID_TIMESTAMP == morph_instance_motion);

                                        assert(ANIMATION_INPUT_TYPE_MOTION_RECEIVER == morph_animation_input_type);
                                    }
                                    else
                                    {
                                    ...
                                    joint_motion_capture = ui_controller->m_new_instance_model_selected_joint_motion_capture;

                                    uint32_t const joint_motion_capture_pose_index = ui_controller->m_new_instance_model_selected_joint_motion_capture_pose_index;

                                    uint32_t const joint_motion_capture_face_index = ui_controller->m_new_instance_model_selected_joint_motion_capture_face_index;

                                    uint32_t const joint_motion_capture_hand_index = ui_controller->m_new_instance_model_selected_joint_motion_capture_hand_index;

                                    joint_instance_motion = ui_controller->m_new_instance_model_selected_joint_instance_motion;

                                    joint_motion_receiver = ui_controller->m_new_instance_model_selected_joint_motion_receiver;

                                    auto const found_joint_motion_capture = ui_model->m_video_detectors.find(joint_motion_capture);

                                    auto const found_joint_instance_motion = ui_model->m_instance_motions.find(joint_instance_motion);

                                    auto const found_joint_motion_receiver = ui_model->m_motion_receivers.find(joint_motion_receiver);

                                    assert((ui_model->m_video_detectors.end() == found_joint_motion_capture) || (ui_model->m_instance_motions.end() == found_joint_instance_motion) || (ui_model->m_motion_receivers.end() == found_joint_motion_receiver));

                                    if (ui_model->m_video_detectors.end() != found_joint_motion_capture)
                                    {
                                        assert(NULL != found_joint_motion_capture->second.m_video_detector);

                                        skeleton_instance->set_joint_input_motion_capture(found_joint_motion_capture->second.m_video_detector->get_motion_capture());
                                        skeleton_instance->set_joint_input_motion_capture_pose_index(joint_motion_capture_pose_index);
                                        skeleton_instance->set_joint_input_motion_capture_face_index(joint_motion_capture_face_index);
                                        skeleton_instance->set_joint_input_motion_capture_hand_index(joint_motion_capture_hand_index);

                                        assert(INVALID_TIMESTAMP == joint_instance_motion);
                                        assert(INVALID_PORT == joint_motion_receiver);
                                    ...
                                    else if (ui_model->m_instance_motions.end() != found_joint_instance_motion)
                                    {
                                        ...
                                        assert(INVALID_TIMESTAMP == joint_motion_capture);
                                        assert(INVALID_PORT == joint_motion_receiver);

                                        assert(ANIMATION_INPUT_TYPE_INSTANCE_MOTION == joint_animation_input_type);
                                    }
                                    else if (ui_model->m_motion_receivers.end() != found_joint_motion_receiver)
                                    {
                                        assert(NULL != found_joint_motion_receiver->second.m_motion_receiver);

                                        skeleton_instance->set_joint_input_motion_capture(found_joint_motion_receiver->second.m_motion_receiver->get_motion_capture());
                                        skeleton_instance->set_joint_input_motion_capture_pose_index(0U);
                                        skeleton_instance->set_joint_input_motion_capture_face_index(0U);
                                        skeleton_instance->set_joint_input_motion_capture_hand_index(0U);

                                        assert(INVALID_TIMESTAMP == joint_motion_capture);
                                        assert(INVALID_TIMESTAMP == joint_instance_motion);

                                        assert(ANIMATION_INPUT_TYPE_MOTION_RECEIVER == joint_animation_input_type);
                                    }
                                    else
                                    {
                                ...
                                bool const enable_root_motion = ui_controller->m_new_instance_model_enable_root_motion;

                                float const model_transform_rotation_x = ui_controller->m_new_instance_model_transform_rotation_x;
                                float const model_transform_rotation_y = ui_controller->m_new_instance_model_transform_rotation_y;
                                float const model_transform_rotation_z = ui_controller->m_new_instance_model_transform_rotation_z;
                                float const model_transform_rotation_w = ui_controller->m_new_instance_model_transform_rotation_w;
                                ...
                                {
                                    brx_anari_rigid_transform const model_transform{{model_transform_rotation_x, model_transform_rotation_y, model_transform_rotation_z, model_transform_rotation_w}, {model_transform_translation_x, model_transform_translation_y, model_transform_translation_z}};
                                ...
                                ui_model->m_instance_models.insert(ui_model->m_instance_models.end(), std::pair<uint64_t, ui_instance_model_model_t>{timestamp, ui_instance_model_model_t{ui_controller->m_new_instance_model_name.data(), asset_model, surface_group_index, surface_group_instance, skeleton_instance, morph_motion_capture, morph_instance_motion, morph_motion_receiver, joint_motion_capture, joint_instance_motion, joint_motion_receiver, enable_root_motion, model_transform_rotation_x, model_transform_rotation_y, model_transform_rotation_z, model_transform_rotation_w, model_transform_translation_x, model_transform_translation_y, model_transform_translation_z}});
                    ...
                    if ((ui_model->m_instance_models.end() != found_instance_model) || (ui_controller->m_instance_controllers.end() != found_instance_controller))
                    {
                        if (ui_model->m_instance_models.end() != found_instance_model)
                        {
                            ...
                            else
                            {
                                ...
                                assert(INVALID_TIMESTAMP == found_instance_model->second.m_morph_motion_capture);
                                assert(INVALID_TIMESTAMP == found_instance_model->second.m_morph_instance_motion);
                                assert(INVALID_TIMESTAMP == found_instance_model->second.m_joint_motion_capture);
            ...
            if (ui_model->m_instance_models.end() != found_instance_model)
            {
                ...
                if (NULL != found_instance_model->second.m_skeleton_instance)
                {
#ifndef NDEBUG
                    {
                        brx_motion_motion_capture *const morph_motion_capture = found_instance_model->second.m_skeleton_instance->get_morph_input_motion_capture();
                        ...
                        assert((NULL == morph_motion_capture) || (NULL == morph_animation_instance));

                        if (NULL != morph_motion_capture)
                        {
                            auto const found_morph_video_detector = ui_model->m_video_detectors.find(found_instance_model->second.m_morph_motion_capture);

                            assert((ui_model->m_video_detectors.end() == found_morph_video_detector) || (morph_motion_capture->get_video_detector() == found_morph_video_detector->second.m_video_detector));

                            auto const found_morph_motion_receiver = ui_model->m_motion_receivers.find(found_instance_model->second.m_morph_motion_capture);

                            assert((ui_model->m_motion_receivers.end() == found_morph_motion_receiver) || (morph_motion_capture->get_motion_receiver() == found_morph_motion_receiver->second.m_motion_receiver));
                        ...
                        brx_motion_motion_capture *const joint_motion_capture = found_instance_model->second.m_skeleton_instance->get_joint_input_motion_capture();
                        ...
                        assert((NULL == joint_motion_capture) || (NULL == joint_animation_instance));

                        if (NULL != joint_motion_capture)
                        {
                            auto const found_joint_video_detector = ui_model->m_video_detectors.find(found_instance_model->second.m_joint_motion_capture);

                            assert((ui_model->m_video_detectors.end() == found_joint_video_detector) || (joint_motion_capture->get_video_detector() == found_joint_video_detector->second.m_video_detector));

                            auto const found_joint_motion_receiver = ui_model->m_motion_receivers.find(found_instance_model->second.m_joint_motion_capture);

                            assert((ui_model->m_motion_receivers.end() == found_joint_motion_receiver) || (joint_motion_capture->get_motion_receiver() == found_joint_motion_receiver->second.m_motion_receiver));
                    ...
                    if (ImGui::BeginTable("##Instance-Model-Manager-Right-Group-Morph-Animation-Input-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
                    {
                        ...
                        if (ANIMATION_INPUT_TYPE_VIDEO_DETECTOR == found_instance_controller.m_morph_animation_input_type)
                        {
                            ...
                            ImGui::TableNextColumn();
                            {
                                ...
                                int selected_combo_index = 0;
                                {
...

                                    {
                                        ...
                                        if (found_instance_model->second.m_morph_motion_capture == item_values[combo_index])
                                        {
                                            assert(0 == selected_combo_index);
                                            assert(0 == combo_index);
                                        }
                                ...
                                if (selected_combo_index >= 0)
                                {
                                    ...
                                    if (found_instance_model->second.m_morph_motion_capture != selected_video_detector)
                                    {
                                        auto const found_video_detector = ui_model->m_video_detectors.find(selected_video_detector);

                                        if (ui_model->m_video_detectors.end() != found_video_detector)
                                        {
                                            found_instance_model->second.m_skeleton_instance->set_morph_input_motion_capture(found_video_detector->second.m_video_detector->get_motion_capture());

                                            found_instance_model->second.m_morph_motion_capture = selected_video_detector;

                                            found_instance_model->second.m_morph_instance_motion = INVALID_TIMESTAMP;

                                            found_instance_model->second.m_morph_motion_receiver = INVALID_PORT;
                                        }
                                        else
                                        {
                                            assert(0 == selected_combo_index);
                                            ...
                                            found_instance_model->second.m_skeleton_instance->set_morph_input_motion_capture(NULL);

                                            found_instance_model->second.m_skeleton_instance->set_morph_input_animation_instance(NULL);

                                            found_instance_model->second.m_morph_motion_capture = INVALID_TIMESTAMP;
                            ...
                            brx_motion_motion_capture *const video_detector = found_instance_model->second.m_skeleton_instance->get_morph_input_motion_capture();
                            ...
                            ImGui::TableNextColumn();
                            {
                                ...
                                if (NULL != video_detector)
                                {
                                    ...
                                    if (pose_count > 0U)
                                    {
                                        ...
                                        int selected_combo_index = 0;
                                        {
                                            ...
                                            for (uint32_t pose_index = 0U; pose_index < pose_count; ++pose_index)
                                            {
                                                ...
                                                if (found_instance_model->second.m_skeleton_instance->get_morph_input_motion_capture_pose_index() == item_values[combo_index])
                                                {
                                                    assert(0 == selected_combo_index);
                                                    assert(static_cast<size_t>(1U + combo_index) < static_cast<size_t>(INT_MAX));
                                                    selected_combo_index = static_cast<int>(combo_index);
                                        ...
                                        if (selected_combo_index >= 0)
                                        {
                                            if (found_instance_model->second.m_skeleton_instance->get_morph_input_motion_capture_pose_index() != item_values[selected_combo_index])
                                            {
                                                found_instance_model->second.m_skeleton_instance->set_morph_input_motion_capture_pose_index(item_values[selected_combo_index]);
                                            }
                                        }
                                        else
                                        {
                                    ...
                                    else
                                    {
                                        ...
                                        found_instance_model->second.m_skeleton_instance->set_morph_input_motion_capture_pose_index(BRX_MOTION_UINT32_INDEX_INVALID);
                                    }
                                }
                                else
                                {
                            ...
                            ImGui::TableNextColumn();
                            {
                                ...
                                if (NULL != video_detector)
                                {
                                    ...
                                    if (face_count > 0U)
                                    {
                                        ...
                                        int selected_combo_index = 0;
                                        {
                                            ...
                                            for (uint32_t face_index = 0U; face_index < face_count; ++face_index)
                                            {
                                                ...
                                                if (found_instance_model->second.m_skeleton_instance->get_morph_input_motion_capture_face_index() == item_values[combo_index])
                                                {
                                                    assert(0 == selected_combo_index);
                                                    assert(static_cast<size_t>(1U + combo_index) < static_cast<size_t>(INT_MAX));
                                                    selected_combo_index = static_cast<int>(combo_index);
                                        ...
                                        if (selected_combo_index >= 0)
                                        {
                                            if (found_instance_model->second.m_skeleton_instance->get_morph_input_motion_capture_face_index() != item_values[selected_combo_index])
                                            {
                                                found_instance_model->second.m_skeleton_instance->set_morph_input_motion_capture_face_index(item_values[selected_combo_index]);
                                            }
                                        }
                                        else
                                        {
                                    ...
                                    else
                                    {
                                        ...
                                        found_instance_model->second.m_skeleton_instance->set_morph_input_motion_capture_face_index(BRX_MOTION_UINT32_INDEX_INVALID);
                                    }
                                }
                                else
                                {
                            ...
                            ImGui::TableNextColumn();
                            {
                                ...
                                if (NULL != video_detector)
                                {
                                    ...
                                    if (hand_count > 0U)
                                    {
                                        ...
                                        int selected_combo_index = 0;
                                        {
                                            ...
                                            for (uint32_t hand_index = 0U; hand_index < hand_count; ++hand_index)
                                            {
                                                ...
                                                if (found_instance_model->second.m_skeleton_instance->get_morph_input_motion_capture_hand_index() == item_values[combo_index])
                                                {
                                                    assert(0 == selected_combo_index);
                                                    assert(static_cast<size_t>(1U + combo_index) < static_cast<size_t>(INT_MAX));
                                                    selected_combo_index = static_cast<int>(combo_index);
                                        ...
                                        if (selected_combo_index >= 0)
                                        {
                                            if (found_instance_model->second.m_skeleton_instance->get_morph_input_motion_capture_hand_index() != item_values[selected_combo_index])
                                            {
                                                found_instance_model->second.m_skeleton_instance->set_morph_input_motion_capture_hand_index(item_values[selected_combo_index]);
                                            }
                                        }
                                        else
                                        {
                                    ...
                                    else
                                    {
                                        ...
                                        found_instance_model->second.m_skeleton_instance->set_morph_input_motion_capture_hand_index(BRX_MOTION_UINT32_INDEX_INVALID);
                                    }
                                }
                                else
                                {
                        ...
                        else if (ANIMATION_INPUT_TYPE_MOTION_RECEIVER == found_instance_controller.m_morph_animation_input_type)
                        {
                            ImGui::TableNextRow();
                            ImGui::TableNextColumn();
                            ImGui::AlignTextToFramePadding();
                            ...
                            ImGui::TableNextColumn();
                            {
                                ...
                                int selected_combo_index = 0;
                                {
...

                                    {
                                        ...
                                        if (found_instance_model->second.m_morph_motion_receiver == item_values[combo_index])
                                        {
                                            assert(0 == selected_combo_index);
                                            assert(0 == combo_index);
                                        }
                                    ...
                                    for (auto const &motion_receiver : ui_model->m_motion_receivers)
                                    {
                                        ...
                                        {
                                            char motion_receiver_port_text[] = {"18446744073709551615"};
                                            std::snprintf(motion_receiver_port_text, sizeof(motion_receiver_port_text) / sizeof(motion_receiver_port_text[0]), "%lld", static_cast<long long unsigned>(item_values[combo_index]));
                                            motion_receiver_port_text[(sizeof(motion_receiver_port_text) / sizeof(motion_receiver_port_text[0])) - 1] = '\0';

                                            item_strings[combo_index] += motion_receiver_port_text;
                                        }
                                ...
                                ImGui::Combo("##Instance-Model-Manager-Right-Group-Morph-Animation-Input-Table-Value-Morph-Motion-Receiver", &selected_combo_index, items.data(), items.size());

                                if (selected_combo_index >= 0)
                                {
                                    uint64_t const selected_motion_receiver = item_values[selected_combo_index];

                                    if (found_instance_model->second.m_morph_motion_receiver != selected_motion_receiver)
                                    {
                                        auto const found_motion_receiver = ui_model->m_motion_receivers.find(selected_motion_receiver);

                                        if (ui_model->m_motion_receivers.end() != found_motion_receiver)
                                        {
                                            found_instance_model->second.m_skeleton_instance->set_morph_input_motion_capture(found_motion_receiver->second.m_motion_receiver->get_motion_capture());
                                            found_instance_model->second.m_skeleton_instance->set_morph_input_motion_capture_pose_index(0);
                                            found_instance_model->second.m_skeleton_instance->set_morph_input_motion_capture_face_index(0);
                                            found_instance_model->second.m_skeleton_instance->set_morph_input_motion_capture_hand_index(0);

                                            found_instance_model->second.m_morph_motion_capture = INVALID_TIMESTAMP;

                                            found_instance_model->second.m_morph_instance_motion = INVALID_TIMESTAMP;

                                            found_instance_model->second.m_morph_motion_receiver = selected_motion_receiver;
                                        }
                                        else
                                        {
                                            assert(0 == selected_combo_index);
                                            assert(INVALID_PORT == selected_motion_receiver);
                    ...
                    if (ImGui::BeginTable("##Instance-Model-Manager-Right-Group-Joint-Animation-Input-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
                    {
                        ...
                        if (ANIMATION_INPUT_TYPE_VIDEO_DETECTOR == found_instance_controller.m_joint_animation_input_type)
                        {
                            ...
                            ImGui::TableNextColumn();
                            {
                                ...
                                int selected_combo_index = 0;
                                {
...

                                    {
                                        ...
                                        if (found_instance_model->second.m_joint_motion_capture == item_values[combo_index])
                                        {
                                            assert(0 == selected_combo_index);
                                            assert(0 == combo_index);
                                        }
                                ...
                                if (selected_combo_index >= 0)
                                {
                                    ...
                                    if (found_instance_model->second.m_joint_motion_capture != selected_video_detector)
                                    {
                                        auto const found_video_detector = ui_model->m_video_detectors.find(selected_video_detector);

                                        if (ui_model->m_video_detectors.end() != found_video_detector)
                                        {
                                            found_instance_model->second.m_skeleton_instance->set_joint_input_motion_capture(found_video_detector->second.m_video_detector->get_motion_capture());

                                            found_instance_model->second.m_joint_motion_capture = selected_video_detector;

                                            found_instance_model->second.m_joint_instance_motion = INVALID_TIMESTAMP;

                                            found_instance_model->second.m_joint_motion_receiver = INVALID_PORT;
                                        }
                                        else
                                        {
                                            assert(0 == selected_combo_index);
                                            ...
                                            found_instance_model->second.m_skeleton_instance->set_joint_input_motion_capture(NULL);

                                            found_instance_model->second.m_skeleton_instance->set_joint_input_animation_instance(NULL);

                                            found_instance_model->second.m_joint_motion_capture = INVALID_TIMESTAMP;
                            ...
                            assert(NULL != found_instance_model->second.m_skeleton_instance);
                            brx_motion_motion_capture *const video_detector = found_instance_model->second.m_skeleton_instance->get_joint_input_motion_capture();
                            ...
                            ImGui::TableNextColumn();
                            {
                                ...
                                if (NULL != video_detector)
                                {
                                    ...
                                    if (pose_count > 0U)
                                    {
                                        ...
                                        int selected_combo_index = 0;
                                        {
                                            ...
                                            for (uint32_t pose_index = 0U; pose_index < pose_count; ++pose_index)
                                            {
                                                ...
                                                if (found_instance_model->second.m_skeleton_instance->get_joint_input_motion_capture_pose_index() == item_values[combo_index])
                                                {
                                                    assert(0 == selected_combo_index);
                                                    assert(static_cast<size_t>(1U + combo_index) < static_cast<size_t>(INT_MAX));
                                                    selected_combo_index = static_cast<int>(combo_index);
                                        ...
                                        if (selected_combo_index >= 0)
                                        {
                                            if (found_instance_model->second.m_skeleton_instance->get_joint_input_motion_capture_pose_index() != item_values[selected_combo_index])
                                            {
                                                found_instance_model->second.m_skeleton_instance->set_joint_input_motion_capture_pose_index(item_values[selected_combo_index]);
                                            }
                                        }
                                        else
                                        {
                                    ...
                                    else
                                    {
                                        ...
                                        found_instance_model->second.m_skeleton_instance->set_joint_input_motion_capture_pose_index(BRX_MOTION_UINT32_INDEX_INVALID);
                                    }
                                }
                                else
                                {
                            ...
                            ImGui::TableNextColumn();
                            {
                                ...
                                if (NULL != video_detector)
                                {
                                    ...
                                    if (face_count > 0U)
                                    {
                                        ...
                                        int selected_combo_index = 0;
                                        {
                                            ...
                                            for (uint32_t face_index = 0U; face_index < face_count; ++face_index)
                                            {
                                                ...
                                                if (found_instance_model->second.m_skeleton_instance->get_joint_input_motion_capture_face_index() == item_values[combo_index])
                                                {
                                                    assert(0 == selected_combo_index);
                                                    assert(static_cast<size_t>(1U + combo_index) < static_cast<size_t>(INT_MAX));
                                                    selected_combo_index = static_cast<int>(combo_index);
                                        ...
                                        if (selected_combo_index >= 0)
                                        {
                                            if (found_instance_model->second.m_skeleton_instance->get_joint_input_motion_capture_face_index() != item_values[selected_combo_index])
                                            {
                                                found_instance_model->second.m_skeleton_instance->set_joint_input_motion_capture_face_index(item_values[selected_combo_index]);
                                            }
                                        }
                                        else
                                        {
                                    ...
                                    else
                                    {
                                        ...
                                        found_instance_model->second.m_skeleton_instance->set_joint_input_motion_capture_face_index(BRX_MOTION_UINT32_INDEX_INVALID);
                                    }
                                }
                                else
                                {
                            ...
                            ImGui::TableNextColumn();
                            {
                                ...
                                if (NULL != video_detector)
                                {
                                    ...
                                    if (hand_count > 0U)
                                    {
                                        ...
                                        int selected_combo_index = 0;
                                        {
                                            ...
                                            for (uint32_t hand_index = 0U; hand_index < hand_count; ++hand_index)
                                            {
                                                ...
                                                if (found_instance_model->second.m_skeleton_instance->get_joint_input_motion_capture_hand_index() == item_values[combo_index])
                                                {
                                                    assert(0 == selected_combo_index);
                                                    assert(static_cast<size_t>(1U + combo_index) < static_cast<size_t>(INT_MAX));
                                                    selected_combo_index = static_cast<int>(combo_index);
                                        ...
                                        if (selected_combo_index >= 0)
                                        {
                                            if (found_instance_model->second.m_skeleton_instance->get_joint_input_motion_capture_hand_index() != item_values[selected_combo_index])
                                            {
                                                found_instance_model->second.m_skeleton_instance->set_joint_input_motion_capture_hand_index(item_values[selected_combo_index]);
                                            }
                                        }
                                        else
                                        {
                                    ...
                                    else
                                    {
                                        ...
                                        found_instance_model->second.m_skeleton_instance->set_joint_input_motion_capture_hand_index(BRX_MOTION_UINT32_INDEX_INVALID);
                                    }
                                }
                                else
                                {
                        ...
                        else if (ANIMATION_INPUT_TYPE_MOTION_RECEIVER == found_instance_controller.m_joint_animation_input_type)
                        {
                            ImGui::TableNextRow();
                            ImGui::TableNextColumn();
                            ImGui::AlignTextToFramePadding();
                            ...
                            ImGui::TableNextColumn();
                            {
                                ...
                                int selected_combo_index = 0;
                                {
...

                                    {
                                        ...
                                        if (found_instance_model->second.m_joint_motion_receiver == item_values[combo_index])
                                        {
                                            assert(0 == selected_combo_index);
                                            assert(0 == combo_index);
                                        }
                                ...
                                ImGui::Combo("##Instance-Model-Manager-Right-Group-Joint-Animation-Input-Table-Value-Joint-Motion-Receiver", &selected_combo_index, items.data(), items.size());

                                if (selected_combo_index >= 0)
                                {
                                    uint64_t const selected_motion_receiver = item_values[selected_combo_index];

                                    if (found_instance_model->second.m_joint_motion_receiver != selected_motion_receiver)
                                    {
                                        auto const found_motion_receiver = ui_model->m_motion_receivers.find(selected_motion_receiver);

                                        if (ui_model->m_motion_receivers.end() != found_motion_receiver)
                                        {
                                            found_instance_model->second.m_skeleton_instance->set_joint_input_motion_capture(found_motion_receiver->second.m_motion_receiver->get_motion_capture());
                                            found_instance_model->second.m_skeleton_instance->set_joint_input_motion_capture_pose_index(0U);
                                            found_instance_model->second.m_skeleton_instance->set_joint_input_motion_capture_face_index(0U);
                                            found_instance_model->second.m_skeleton_instance->set_joint_input_motion_capture_hand_index(0U);

                                            found_instance_model->second.m_joint_motion_capture = INVALID_TIMESTAMP;

                                            found_instance_model->second.m_joint_instance_motion = INVALID_TIMESTAMP;

                                            found_instance_model->second.m_joint_motion_receiver = selected_motion_receiver;
                                        }
                                        else
                                        {
                                            assert(0 == selected_combo_index);
                        ...
                        ImGui::TableNextColumn();
                        {
                            ImGui::Checkbox("##Instance-Model-Manager-Right-Group-Joint-Animation-Input-Table-Value-Enable-Root-Motion", &found_instance_model->second.m_enable_root_motion);
                        }
                ...
                else
                {
                    assert(INVALID_TIMESTAMP == found_instance_model->second.m_morph_motion_capture);
                    assert(INVALID_TIMESTAMP == found_instance_model->second.m_morph_instance_motion);
                    assert(INVALID_PORT == found_instance_model->second.m_morph_motion_receiver);
                    assert(INVALID_TIMESTAMP == found_instance_model->second.m_joint_motion_capture);
                    assert(INVALID_TIMESTAMP == found_instance_model->second.m_joint_instance_motion);
                    assert(INVALID_PORT == found_instance_model->second.m_joint_motion_receiver);
                }
                ...
                if (ImGui::BeginTable("##Instance-Model-Manager-Right-Group-Model-Transform-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
                {
...

                    {
                        ...
                        {
                            float rotation = std::min(std::max(-1.0F, found_instance_model->second.m_model_transform_rotation_x), 1.0F);
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                            ImGui::SliderFloat("##Instance-Model-Manager-Right-Group-Model-Transform-Table-Value-Model-Transform-Rotation-Quaternion-X-Slider", &rotation, -1.0F, 1.0F, "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f");
...
#undef _INTERNAL_BRX_X_STRINGIZING
                            ...
                            ImGui::InputText("##Instance-Model-Manager-Right-Group-Model-Transform-Table-Value-Model-Transform-Rotation-Quaternion-X-Text", &rotation_text[0], sizeof(rotation_text) / sizeof(rotation_text[0]), ImGuiInputTextFlags_CharsDecimal);

                            found_instance_model->second.m_model_transform_rotation_x = std::min(std::max(-1.0F, std::strtof(rotation_text, NULL)), 1.0F);
                        }
                        ...
                        {
                            float rotation = std::min(std::max(-1.0F, found_instance_model->second.m_model_transform_rotation_y), 1.0F);
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                            ImGui::SliderFloat("##Instance-Model-Manager-Right-Group-Model-Transform-Table-Value-Model-Transform-Rotation-Quaternion-Y-Slider", &rotation, -1.0F, 1.0F, "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f");
...
#undef _INTERNAL_BRX_X_STRINGIZING
                            ...
                            ImGui::InputText("##Instance-Model-Manager-Right-Group-Model-Transform-Table-Value-Model-Transform-Rotation-Quaternion-Y-Text", &rotation_text[0], sizeof(rotation_text) / sizeof(rotation_text[0]), ImGuiInputTextFlags_CharsDecimal);

                            found_instance_model->second.m_model_transform_rotation_y = std::min(std::max(-1.0F, std::strtof(rotation_text, NULL)), 1.0F);
                        }
                        ...
                        {
                            float rotation = std::min(std::max(-1.0F, found_instance_model->second.m_model_transform_rotation_z), 1.0F);
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                            ImGui::SliderFloat("##Instance-Model-Manager-Right-Group-Model-Transform-Table-Value-Model-Transform-Rotation-Quaternion-Z-Slider", &rotation, -1.0F, 1.0F, "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f");
...
#undef _INTERNAL_BRX_X_STRINGIZING
                            ...
                            ImGui::InputText("##Instance-Model-Manager-Right-Group-Model-Transform-Table-Value-Model-Transform-Rotation-Quaternion-Z-Text", &rotation_text[0], sizeof(rotation_text) / sizeof(rotation_text[0]), ImGuiInputTextFlags_CharsDecimal);

                            found_instance_model->second.m_model_transform_rotation_z = std::min(std::max(-1.0F, std::strtof(rotation_text, NULL)), 1.0F);
                        }
                        ...
                        {
                            float rotation = std::min(std::max(-1.0F, found_instance_model->second.m_model_transform_rotation_w), 1.0F);
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                            ImGui::SliderFloat("##Instance-Model-Manager-Right-Group-Model-Transform-Table-Value-Model-Transform-Rotation-Quaternion-W-Slider", &rotation, -1.0F, 1.0F, "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f");
...
#undef _INTERNAL_BRX_X_STRINGIZING
                            ...
                            ImGui::InputText("##Instance-Model-Manager-Right-Group-Model-Transform-Table-Value-Model-Transform-Rotation-Quaternion-W-Text", &rotation_text[0], sizeof(rotation_text) / sizeof(rotation_text[0]), ImGuiInputTextFlags_CharsDecimal);

                            found_instance_model->second.m_model_transform_rotation_w = std::min(std::max(-1.0F, std::strtof(rotation_text, NULL)), 1.0F);
                        }

                        {
                            DirectX::XMFLOAT4 const directx_rotation_quaternion(found_instance_model->second.m_model_transform_rotation_x, found_instance_model->second.m_model_transform_rotation_y, found_instance_model->second.m_model_transform_rotation_z, found_instance_model->second.m_model_transform_rotation_w);

                            DirectX::XMFLOAT4 directx_normalized_rotation_quaternion;
                            DirectX::XMStoreFloat4(&directx_normalized_rotation_quaternion, DirectX::XMQuaternionNormalize(DirectX::XMLoadFloat4(&directx_rotation_quaternion)));
                            found_instance_model->second.m_model_transform_rotation_x = directx_normalized_rotation_quaternion.x;
                            found_instance_model->second.m_model_transform_rotation_y = directx_normalized_rotation_quaternion.y;
                            found_instance_model->second.m_model_transform_rotation_z = directx_normalized_rotation_quaternion.z;
                            found_instance_model->second.m_model_transform_rotation_w = directx_normalized_rotation_quaternion.w;
                        }
                    }
...
#undef _INTERNAL_BRX_X_STRINGIZING
                    ...
                    {
                        brx_anari_rigid_transform const model_transform{{found_instance_model->second.m_model_transform_rotation_x, found_instance_model->second.m_model_transform_rotation_y, found_instance_model->second.m_model_transform_rotation_z, found_instance_model->second.m_model_transform_rotation_w}, {found_instance_model->second.m_model_transform_translation_x, found_instance_model->second.m_model_transform_translation_y, found_instance_model->second.m_model_transform_translation_z}};
    ...
    if (ui_controller->m_show_camera_manager)
    {
        ...
        if (ImGui::Begin("Camera Manager", &ui_controller->m_show_camera_manager))
        {
            {
                constexpr char const *const text[LANGUAGE_COUNT] = {
                    "Camera Manager",
...
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                        std::snprintf(&position_text[0], sizeof(position_text) / sizeof(position_text[0]), "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f", ui_model->m_camera_position.m_x);
#undef _INTERNAL_BRX_STRINGIZING
#undef _INTERNAL_BRX_X_STRINGIZING
                        ...
                        ui_model->m_camera_position.m_x = std::strtof(position_text, NULL);
                    }
...
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                        std::snprintf(&position_text[0], sizeof(position_text) / sizeof(position_text[0]), "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f", ui_model->m_camera_position.m_y);
#undef _INTERNAL_BRX_STRINGIZING
#undef _INTERNAL_BRX_X_STRINGIZING
                        position_text[(sizeof(position_text) / sizeof(position_text[0]) - 1)] = '\0';
                        ...
                        ui_model->m_camera_position.m_y = std::strtof(position_text, NULL);
                    }
...
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                        std::snprintf(&position_text[0], sizeof(position_text) / sizeof(position_text[0]), "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f", ui_model->m_camera_position.m_z);
#undef _INTERNAL_BRX_STRINGIZING
#undef _INTERNAL_BRX_X_STRINGIZING
                        position_text[(sizeof(position_text) / sizeof(position_text[0]) - 1)] = '\0';
                        ...
                        ui_model->m_camera_position.m_z = std::strtof(position_text, NULL);
                    }
                }
...
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                        std::snprintf(&direction_text[0], sizeof(direction_text) / sizeof(direction_text[0]), "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f", ui_model->m_camera_direction.m_x);
#undef _INTERNAL_BRX_STRINGIZING
#undef _INTERNAL_BRX_X_STRINGIZING
                        ...
                        ui_model->m_camera_direction.m_x = std::strtof(direction_text, NULL);
                    }
...
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                        std::snprintf(&direction_text[0], sizeof(direction_text) / sizeof(direction_text[0]), "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f", ui_model->m_camera_direction.m_y);
#undef _INTERNAL_BRX_STRINGIZING
#undef _INTERNAL_BRX_X_STRINGIZING
                        direction_text[(sizeof(direction_text) / sizeof(direction_text[0]) - 1)] = '\0';
                        ...
                        ui_model->m_camera_direction.m_y = std::strtof(direction_text, NULL);
                    }
...
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                        std::snprintf(&direction_text[0], sizeof(direction_text) / sizeof(direction_text[0]), "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f", ui_model->m_camera_direction.m_z);
#undef _INTERNAL_BRX_STRINGIZING
#undef _INTERNAL_BRX_X_STRINGIZING
                        direction_text[(sizeof(direction_text) / sizeof(direction_text[0]) - 1)] = '\0';
                        ...
                        ui_model->m_camera_direction.m_z = std::strtof(direction_text, NULL);
                    }

                    {
                        DirectX::XMFLOAT3 const directx_camera_direction(ui_model->m_camera_direction.m_x, ui_model->m_camera_direction.m_y, ui_model->m_camera_direction.m_z);
                        ...
                        ui_model->m_camera_direction.m_x = directx_normalized_camera_direction.x;
                        ui_model->m_camera_direction.m_y = directx_normalized_camera_direction.y;
                        ui_model->m_camera_direction.m_z = directx_normalized_camera_direction.z;
                    }
                }
...
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                        std::snprintf(&up_text[0], sizeof(up_text) / sizeof(up_text[0]), "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f", ui_model->m_camera_up.m_x);
#undef _INTERNAL_BRX_STRINGIZING
#undef _INTERNAL_BRX_X_STRINGIZING
                        ...
                        ui_model->m_camera_up.m_x = std::strtof(up_text, NULL);
                    }
...
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                        std::snprintf(&up_text[0], sizeof(up_text) / sizeof(up_text[0]), "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f", ui_model->m_camera_up.m_y);
#undef _INTERNAL_BRX_STRINGIZING
#undef _INTERNAL_BRX_X_STRINGIZING
                        up_text[(sizeof(up_text) / sizeof(up_text[0]) - 1)] = '\0';
                        ...
                        ui_model->m_camera_up.m_y = std::strtof(up_text, NULL);
                    }
...
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                        std::snprintf(&up_text[0], sizeof(up_text) / sizeof(up_text[0]), "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f", ui_model->m_camera_up.m_z);
#undef _INTERNAL_BRX_STRINGIZING
#undef _INTERNAL_BRX_X_STRINGIZING
                        up_text[(sizeof(up_text) / sizeof(up_text[0]) - 1)] = '\0';
                        ...
                        ui_model->m_camera_up.m_z = std::strtof(up_text, NULL);
                    }

                    {
                        DirectX::XMFLOAT3 const directx_camera_up(ui_model->m_camera_up.m_x, ui_model->m_camera_up.m_y, ui_model->m_camera_up.m_z);
                        ...
                        ui_model->m_camera_up.m_x = directx_normalized_camera_up.x;
                        ui_model->m_camera_up.m_y = directx_normalized_camera_up.y;
                        ui_model->m_camera_up.m_z = directx_normalized_camera_up.z;
                    }
                }
...
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                        ...
                        char fovy_text[256];
                        std::snprintf(&fovy_text[0], sizeof(fovy_text) / sizeof(fovy_text[0]), "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f", fovy);
#undef _INTERNAL_BRX_STRINGIZING
#undef _INTERNAL_BRX_X_STRINGIZING
                        fovy_text[(sizeof(fovy_text) / sizeof(fovy_text[0]) - 1)] = '\0';
...
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                        std::snprintf(&near_text[0], sizeof(near_text) / sizeof(near_text[0]), "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f", std::max(0.001F, ui_model->m_camera_near));
#undef _INTERNAL_BRX_STRINGIZING
#undef _INTERNAL_BRX_X_STRINGIZING
                        ...
                        ui_model->m_camera_near = std::max(0.001F, std::strtof(near_text, NULL));
                    }
                }
...
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                        std::snprintf(&far_text[0], sizeof(far_text) / sizeof(far_text[0]), "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f", std::max((ui_model->m_camera_near + 0.001F), ui_model->m_camera_far));
#undef _INTERNAL_BRX_STRINGIZING
#undef _INTERNAL_BRX_X_STRINGIZING
                        ...
                        ui_model->m_camera_far = std::max((ui_model->m_camera_near + 0.001F), std::strtof(far_text, NULL));
                    }
                }
...
#undef _INTERNAL_BRX_X_STRINGIZING
    ...
    if (ui_controller->m_show_physics_ragdoll_manager)
    {
        ...
        if (ImGui::Begin("Physics Ragdoll Manager", &ui_controller->m_show_physics_ragdoll_manager))
        {
            {
                constexpr char const *const text[LANGUAGE_COUNT] = {
                    "Physics Ragdoll Manager",
            ...
            if (ImGui::BeginTable("##Physics-Ragdoll-Manager-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
            {
                ...
                ImGui::TableNextColumn();
                {
                    ...
                    int select_physics_ragdoll_quality = std::min(std::max(0, static_cast<int>(ui_model->m_physics_ragdoll_quality)), (int(BRX_MOTION_PHYSICS_RAGDOLL_QUALITY_COUNT) - 1));
                    ...
                    ui_model->m_physics_ragdoll_quality = static_cast<BRX_MOTION_PHYSICS_RAGDOLL_QUALITY>(std::min(std::max(0, select_physics_ragdoll_quality), (int(BRX_MOTION_PHYSICS_RAGDOLL_QUALITY_COUNT) - 1)));
                }
    ...
    if (ui_controller->m_show_window_manager)
    {
        ...
        if (ImGui::Begin("Window Manager", &ui_controller->m_show_window_manager))
        {
            {
                constexpr char const *const text[LANGUAGE_COUNT] = {
                    "Window Manager",
    ...
    if (ui_controller->m_show_directional_lighting_manager)
    {
        {
            ImGuiViewport const *const main_viewport = ImGui::GetMainViewport();
            ImGui::SetNextWindowPos(ImVec2(main_viewport->WorkPos.x + ui_x * ui_index, main_viewport->WorkPos.y + ui_y * ui_index), ImGuiCond_FirstUseEver);
        ...
        if (ImGui::Begin("Directional Lighting Manager", &ui_controller->m_show_directional_lighting_manager))
        {
            {
                constexpr char const *const text[LANGUAGE_COUNT] = {
                    "Directional Lighting Manager",
            ...
            if (ImGui::BeginTable("##Directional-Lighting-Manager-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
            {
                ImGui::TableSetupColumn("##Directional-Lighting-Manager-Table-Property", ImGuiTableColumnFlags_WidthFixed);
                ImGui::TableSetupColumn("##Directional-Lighting-Manager-Table-Value", ImGuiTableColumnFlags_WidthStretch);
                ...
                ImGui::TableNextColumn();
                {
                    ImGui::Checkbox("##Directional-Lighting-Manager-Table-Value-Enable-Debug-Renderer", &ui_model->m_directional_lighting_visible);
                }
                ...
                ImGui::TableNextColumn();
                {
                    float directional_lighting_color_rgb[3] = {ui_model->m_directional_lighting_color_r, ui_model->m_directional_lighting_color_g, ui_model->m_directional_lighting_color_b};

                    ImGui::ColorEdit3("##Directional-Lighting-Manager-Table-Value-Color", directional_lighting_color_rgb);

                    ui_model->m_directional_lighting_color_r = directional_lighting_color_rgb[0];
                    ui_model->m_directional_lighting_color_g = directional_lighting_color_rgb[1];
                    ui_model->m_directional_lighting_color_b = directional_lighting_color_rgb[2];
                }
...
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                    std::snprintf(&radiance_text[0], sizeof(radiance_text) / sizeof(radiance_text[0]), "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f", ui_model->m_directional_lighting_irradiance);
#undef _INTERNAL_BRX_STRINGIZING
#undef _INTERNAL_BRX_X_STRINGIZING
                    radiance_text[(sizeof(radiance_text) / sizeof(radiance_text[0]) - 1)] = '\0';

                    ImGui::InputText("##Directional-Lighting-Manager-Table-Value-Irradiance", &radiance_text[0], sizeof(radiance_text) / sizeof(radiance_text[0]), ImGuiInputTextFlags_CharsDecimal);

                    ui_model->m_directional_lighting_irradiance = std::strtof(radiance_text, NULL);
                }
...
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                        std::snprintf(&direction_text[0], sizeof(direction_text) / sizeof(direction_text[0]), "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f", ui_model->m_directional_lighting_direction_x);
#undef _INTERNAL_BRX_STRINGIZING
#undef _INTERNAL_BRX_X_STRINGIZING
                        direction_text[(sizeof(direction_text) / sizeof(direction_text[0]) - 1)] = '\0';

                        ImGui::InputText("##Directional-Lighting-Manager-Table-Value-Direction-X", &direction_text[0], sizeof(direction_text) / sizeof(direction_text[0]), ImGuiInputTextFlags_CharsDecimal);

                        ui_model->m_directional_lighting_direction_x = std::strtof(direction_text, NULL);
                    }
...
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                        std::snprintf(&direction_text[0], sizeof(direction_text) / sizeof(direction_text[0]), "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f", ui_model->m_directional_lighting_direction_y);
#undef _INTERNAL_BRX_STRINGIZING
#undef _INTERNAL_BRX_X_STRINGIZING
                        direction_text[(sizeof(direction_text) / sizeof(direction_text[0]) - 1)] = '\0';

                        ImGui::InputText("##Directional-Lighting-Manager-Table-Value-Direction-Y", &direction_text[0], sizeof(direction_text) / sizeof(direction_text[0]), ImGuiInputTextFlags_CharsDecimal);

                        ui_model->m_directional_lighting_direction_y = std::strtof(direction_text, NULL);
                    }
...
#define _INTERNAL_BRX_STRINGIZING(string) #string
#define _INTERNAL_BRX_X_STRINGIZING(string) _INTERNAL_BRX_STRINGIZING(string)
                        std::snprintf(&direction_text[0], sizeof(direction_text) / sizeof(direction_text[0]), "%." _INTERNAL_BRX_X_STRINGIZING(DBL_DIG) "f", ui_model->m_directional_lighting_direction_z);
#undef _INTERNAL_BRX_STRINGIZING
#undef _INTERNAL_BRX_X_STRINGIZING
                        direction_text[(sizeof(direction_text) / sizeof(direction_text[0]) - 1)] = '\0';

                        ImGui::InputText("##Directional-Lighting-Manager-Table-Value-Direction-Z", &direction_text[0], sizeof(direction_text) / sizeof(direction_text[0]), ImGuiInputTextFlags_CharsDecimal);

                        ui_model->m_directional_lighting_direction_z = std::strtof(direction_text, NULL);
                    }

                    {
                        DirectX::XMFLOAT3 const directx_camera_direction(ui_model->m_directional_lighting_direction_x, ui_model->m_directional_lighting_direction_y, ui_model->m_directional_lighting_direction_z);

                        DirectX::XMFLOAT3 directx_normalized_camera_direction;
                        DirectX::XMStoreFloat3(&directx_normalized_camera_direction, DirectX::XMVector3Normalize(DirectX::XMLoadFloat3(&directx_camera_direction)));

                        ui_model->m_directional_lighting_direction_x = directx_normalized_camera_direction.x;
                        ui_model->m_directional_lighting_direction_y = directx_normalized_camera_direction.y;
                        ui_model->m_directional_lighting_direction_z = directx_normalized_camera_direction.z;
                    }
                }
    ...
    if (ui_controller->m_show_area_lighting_manager)
    {
        ...
        if (ImGui::Begin("Area Lighting Manager", &ui_controller->m_show_area_lighting_manager))
        {
            {
                constexpr char const *const text[LANGUAGE_COUNT] = {
                    "Area Lighting Manager",
            ...
            if (ImGui::BeginTable("##Area-Lighting-Manager-Configuration-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
            {
                ...
                ImGui::TableNextColumn();
                {
                    ImGui::Checkbox("##Area-Lighting-Manager-Configuration-Table-Value-Enable-Debug-Renderer", &ui_model->m_quad_light_enable_debug_renderer);
                }
...
#undef _INTERNAL_BRX_X_STRINGIZING
    ...
    if (ui_controller->m_show_environment_lighting_manager)
    {
        ...
        if (ImGui::Begin("Environment Lighting Manager", &ui_controller->m_show_environment_lighting_manager))
        {
            {
                constexpr char const *const text[LANGUAGE_COUNT] = {
                    "Environment Lighting Manager",
            ...
            if (ImGui::BeginTable("##Environment-Lighting-Manager-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
            {
                ...
                ImGui::TableNextColumn();
                {
                    ImGui::Checkbox("##Environment-Lighting-Manager-Table-Value-Enable-Skybox-Renderer", &ui_model->m_hdri_light_enable_skybox_renderer);
                }
                ...
                ImGui::TableNextColumn();
                {
                    constexpr char const *const label = "##Environment-Lighting-Manager-Table-Value-Select-Asset-Image";
                ...
                ImGui::TableNextColumn();
                {
                    ...
                    ImGui::Combo("##Environment-Lighting-Manager-Table-Value-Layout", &select_layout, items[ui_controller->m_language_index], IM_ARRAYSIZE(items[0]));
...
#undef _INTERNAL_BRX_X_STRINGIZING
    ...
    if (ui_controller->m_show_global_illumination_manager)
    {
        ...
        if (ImGui::Begin("Global Illumination Manager", &ui_controller->m_show_global_illumination_manager))
        {
            {
                constexpr char const *const text[LANGUAGE_COUNT] = {
                    "Global Illumination Manager",
    ...
    if (ui_controller->m_show_acknowledgement)
    {
        ...
        if (ImGui::Begin("Acknowledgement", &ui_controller->m_show_acknowledgement))
        {
            {
                constexpr char const *const text[LANGUAGE_COUNT] = {
                    "Acknowledgement",
