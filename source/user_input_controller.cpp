...
extern void ui_controller_init(brx_anari_device *device, ui_controller_t *ui_controller)
{
    ...
    ui_controller->m_show_about = false;
...

    {
...

        {
            if (ImGui::BeginTable("##Show-Manager-Table", 2, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
            {
                ...
                ImGui::TableNextColumn();
                {
                    ImGui::Checkbox("##Show-About", &ui_controller->m_show_about);
                }
...
#undef _INTERNAL_BRX_X_STRINGIZING
    ...
    if (ui_controller->m_show_about)
    {
        ...
        ImGui::Begin("About", &ui_controller->m_show_about);
        ...
        if (ImGui::BeginTable("##About-Table", 3, ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersInnerV))
        {
            ImGui::TableSetupColumn("##About-Table-Name", ImGuiTableColumnFlags_WidthStretch);
            ImGui::TableSetupColumn("##About-Table-Author", ImGuiTableColumnFlags_WidthStretch);
            ImGui::TableSetupColumn("##About-Table-License", ImGuiTableColumnFlags_WidthStretch);

            ImGui::TableNextRow();
            ImGui::TableNextColumn();
            ImGui::AlignTextToFramePadding();
            ImGui::TextUnformatted("Brioche Puppet");

            ImGui::TableNextColumn();
            ImGui::TextUnformatted("Hanetaka Chou");
