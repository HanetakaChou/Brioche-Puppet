...
struct ui_controller_t
{
    ...
    uint64_t m_new_instance_model_selected_morph_motion_capture;
    uint32_t m_new_instance_model_selected_morph_motion_capture_pose_index;
    uint32_t m_new_instance_model_selected_morph_motion_capture_face_index;
    uint32_t m_new_instance_model_selected_morph_motion_capture_hand_index;
    ...
    uint64_t m_new_instance_model_selected_joint_motion_capture;
    uint32_t m_new_instance_model_selected_joint_motion_capture_pose_index;
    uint32_t m_new_instance_model_selected_joint_motion_capture_face_index;
    uint32_t m_new_instance_model_selected_joint_motion_capture_hand_index;
    uint64_t m_new_instance_model_selected_joint_instance_motion;
    uint16_t m_new_instance_model_selected_joint_motion_receiver;
    bool m_new_instance_model_enable_root_motion;
    float m_new_instance_model_transform_rotation_x;
    float m_new_instance_model_transform_rotation_y;
    float m_new_instance_model_transform_rotation_z;
    float m_new_instance_model_transform_rotation_w;
